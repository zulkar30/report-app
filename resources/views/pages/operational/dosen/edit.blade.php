                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.dosen.update', [$dosen->id]) }}" method="POST"
                                                        ...
                                                        <select name="user_id" id="user_id" class="form-control select2"
                                                            ...
                                                            @foreach ($user as $key => $user_item)
                                                                <option value="{{ $user_item->id }}"
                                                                    {{ $dosen->user_id == $user_item->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            ...
                                                            value="{{ old('name', isset($dosen) ? $dosen->name : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="nik_nip" name="nik_nip"
                                                            ...
                                                            value="{{ old('nik_nip', isset($dosen) ? $dosen->nik_nip : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="birth_place" name="birth_place"
                                                            ...
                                                            value="{{ old('birth_place', isset($dosen) ? $dosen->birth_place : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="date" id="birth_date" name="birth_date"
                                                            class="form-control"
                                                            value="{{ old('birth_date', isset($dosen) ? $dosen->birth_date : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="gender" id="gender"
                                                            ...
                                                            <option
                                                                value="{{ old('gender', isset($dosen) ? $dosen->gender : '') }}"
                                                                disabled selected>
                                                                @if ($dosen->gender == 1)
                                                                    <span>Laki-laki</span>
                                                                @else
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="contact" name="contact"
                                                            class="form-control"
                                                            value="{{ old('contact', isset($dosen) ? $dosen->contact : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="address" name="address"
                                                            class="form-control"
                                                            value="{{ old('address', isset($dosen) ? $dosen->address : '') }}"
                                                            autocomplete="off"
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="position_id" id="position_id"
                                                            class="form-control select2" required>
                                                            <option
                                                                value="{{ old('position_id', isset($dosen) ? $dosen->position_id : '') }}"
                                                                disabled selected>{{ $dosen->position->name }}
                                                            </option>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.dosen.index') }}" style="width:120px;"
