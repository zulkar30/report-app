                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.mahasiswa.store') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nim" name="nim"
                                                                ...
                                                                value="{{ old('nim') }}" autocomplete="off" required>
                                                    ...
                                                    <tbody>
                                                        @forelse($mahasiswa as $key => $mahasiswa_item)
                                                            <tr data-entry-id="{{ $mahasiswa_item->id }}">
                                                                <td>{{ isset($mahasiswa_item->created_at) ? date('d/m/Y H:i:s', strtotime($mahasiswa_item->created_at)) : '' }}
                                                                </td>
                                                                <td>{{ $mahasiswa_item->name ?? '' }}</td>
                                                                <td>{{ $mahasiswa_item->kelas->name ?? '' }}</td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $mahasiswa_item->photo }}"
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('mahasiswa_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.mahasiswa.show', $mahasiswa_item->id) }}"
                                                                            ...
                                                                            @can('mahasiswa_edit')
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.mahasiswa.edit', $mahasiswa_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @can('mahasiswa_delete')
                                                                                <form
                                                                                    action="{{ route('backsite.mahasiswa.destroy', $mahasiswa_item->id) }}"
                                                                                    method="POST"
